...
from script4 import Iterator1txt
...
class ClssDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        #C:\\Users\\user\\Desktop\\AP_LAB3
        self.__iterator = Iterator1txt(os.path.join("\\Users", "\\user", "\\Desktop", "\\AP_LAB3"), "1", "data")
        self.resize(640, 650)
...
if __name__ == "__main__":
    ...
    MainWindow.setStyleSheet("#MainWindow{border-image:url(IMG_9779.jpg)}")
    MainWindow.show()
    sys.exit(app.exec())